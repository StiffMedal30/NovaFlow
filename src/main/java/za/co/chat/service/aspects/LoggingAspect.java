package za.co.chat.service.aspects;
...
public class LoggingAspect {
    ...
    // Log all methods inside the service package
    @Pointcut("execution(* za.co.chat.service..*(..))")
    public void serviceMethods() {

    }

    @AfterThrowing(pointcut = "execution(* za.co.chat..*(..))", throwing = "ex")
